class Solution:
    ...
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        ...
        while True:
            ai = (l + r) // 2 # mid of array a 
            bi = mid - ai - 2 # mid of arry b 
            ...
            if a_left <= b_right and b_left <= a_right:
                # we are a correct partition
                # that is if we merge them, then the median should be there
                if size % 2 == 1:
